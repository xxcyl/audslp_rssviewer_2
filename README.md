...
### v2.7.0 (2025年8月13日) - 文章卡片終極優化完成 🎨
- ✅ **愛心按鈕右上角** - 移至期刊標籤旁，形成視覺平衡和社群互動焦點
- ✅ **移除摘要標籤** - 移除「中文摘要」和「English Abstract」冗餘標題
- ✅ **時間位置優化** - 發布時間移至摘要上方，建立內容時間關聯性
- ✅ **底部純功能化** - 底部只保留操作按鈕，成為純粹工具列
- ✅ **雙摘要直接顯示** - 移除展開/收合按鈕，中英文摘要同時可見
- ✅ **色彩區分優化** - 藍色框（中文）+ 灰色框（英文）+ 斜體字自然區分
- ✅ **佈局邏輯重構** - 頂部（識別）+ 中部（內容）+ 底部（操作）清晰分層
